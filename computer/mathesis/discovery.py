...
class ConjectureDiscoveryEngine:
    ...
    def discover_once(self) -> dict[str, Any]:
        ...
        theorem = {
            ...
            **selected,
            ...
            "memory_novelty": "not_previously_stored",
            "source_novelty": "unassessed",
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "novelty_policy": {
                "memory": "not previously stored means internally novel only",
                "sources": "unassessed unless explicit scholarly source comparison is performed",
                "humanity": "never inferred automatically",
            },

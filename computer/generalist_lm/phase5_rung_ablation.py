...
def run_ablation(state_dir: str | Path) -> dict[str, Any]:
    ...
    policies = [
        {
            "policy": "BATCH32_4K_ONE_UPDATE",
            "causal_batch_size": 32,
            "ffn_multiplier": 1.0,
            "replay_loss_weight": 4.0,
        },
        {
            "policy": "BATCH64_8K_ONE_UPDATE",
            "causal_batch_size": 64,
            "ffn_multiplier": 1.0,
            "replay_loss_weight": 4.0,
        },
        {
            "policy": "BATCH64_8K_ONE_UPDATE_FFN05",
            "causal_batch_size": 64,
            "ffn_multiplier": 0.5,
            "replay_loss_weight": 4.0,
        },
        {
            "policy": "BATCH64_8K_ONE_UPDATE_REPLAY2",
            "causal_batch_size": 64,
            "ffn_multiplier": 1.0,
            "replay_loss_weight": 2.0,
        },
    ]
    variants = [
        {
            ...
            "lr_factor": 1.0,
            "causal_batch_size": policy["causal_batch_size"],
            "replay_batch_size": 2,
            "replay_sampling": "elementary",
            "replay_loss_weight": policy["replay_loss_weight"],
            "kl_weight": 0.50,
    ...
    for variant in variants:
        ...
        for local_step in range(local_steps):
            ...
            causal_batch_size = max(1, int(variant.get("causal_batch_size", 32)))
            indices = [rng.randrange(len(blocks)) for _ in range(causal_batch_size)]
            ...
            causal_supervised_total += supervised
            objective = {}
        ...
        accepted, gate = _segment_language_gate(
            ...
            after,
            anchor,
            attempted_tokens=int(causal_supervised_total),
        )
        ...
        results.append({
            ...
            "steps": local_steps,
            "causal_batch_size": int(variant.get("causal_batch_size", 32)),
            "attempted_tokens": int(causal_supervised_total),
            "multipliers": multipliers,
    ...
    return {
        "schema": 1,
        "version": "phase5-single-update-rung-ablation-v1",
        "read_only": True,
        ...
        "variants": [
            {
                ...
                "causal_batch_size": row["causal_batch_size"],
